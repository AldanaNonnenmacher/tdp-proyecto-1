...
public class SimplePresentationScreen extends JFrame {
	...
	private void init() {
		...
		lblNewLabel_LU.setFont(new Font("Times New Roman", Font.BOLD, 11));
		lblNewLabel_LU.setBounds(10, 11, 65, 24);
		tabInformation.add(lblNewLabel_LU);
		
		JLabel lblNewLabel_Apellido = new JLabel("Apellido");
		lblNewLabel_Apellido.setFont(new Font("Times New Roman", Font.BOLD, 13));
		...
		lblNewLabel_Nombre.setFont(new Font("Times New Roman", Font.BOLD, 13));
		lblNewLabel_Nombre.setBounds(10, 81, 65, 26);
		tabInformation.add(lblNewLabel_Nombre);
		
		JLabel lblNewLabel_Email = new JLabel("E-mail");
		lblNewLabel_Email.setFont(new Font("Times New Roman", Font.BOLD, 13));
		...
		lblNewLabel_Github.setFont(new Font("Times New Roman", Font.BOLD, 13));
		lblNewLabel_Github.setBounds(10, 153, 65, 19);
		...
		lblNewLabel_imagen.setIcon(new ImageIcon(SimplePresentationScreen.class.getResource(studentData.getPathPhoto())));
		...
		JLabel lblNewLabel_horaFecha = new JLabel("Esta ventana fue generada el "+f.format(fechaActual)+" a las "+h.format(horaActual));
